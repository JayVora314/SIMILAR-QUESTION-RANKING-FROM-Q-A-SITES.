...
#Variables
initial_text = StringVar()
initial_text.set("Enter your Query Here..!")
...
def oneClick():
    ...
    in_btn1 = ttk.Button(in_frame1,width=25,text="Question Link",command=lambda: 
webbrowser.open(links[0]))
    ...
    in_btn2 = ttk.Button(in_frame2,width=25,text="Question Link",command=lambda: 
webbrowser.open(links[1]))
    ...
    in_btn3 = ttk.Button(in_frame3,width=25,text="Question Link",command=lambda: 
webbrowser.open(links[2]))
    ...
    in_btn4 = ttk.Button(in_frame4,width=25,text="Question Link",command=lambda: 
webbrowser.open(links[3]))
    ...
    in_btn5 = ttk.Button(in_frame5,width=25,text="Question Link",command=lambda: 
webbrowser.open(links[4]))
    ...
    in_btn6 = ttk.Button(in_frame6,width=25,text="Question Link",command=lambda: 
webbrowser.open(links[5]))
    ...
    in_btn7 = ttk.Button(in_frame7,width=25,text="Question Link",command=lambda: 
...
Label(frame1,text="Please enter the query question in the box and hit submit!").grid(row=0,sticky = 'w',padx = 10,pady = 10)
