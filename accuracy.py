...
final_simscores= np.add(use_simscores*(7/9), sbert_simscores*(2/9))
for n in range(1,11):
    ...
    for i in range((final_simscores.shape)[0]):
        ...
        # if any of the actual similar question IDs is present in the predicted similar question IDs then I increment the correct counter
